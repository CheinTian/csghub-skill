# POST /{repo_type}/{namespace}/{name}/raw/{file_path}

**Resource:** [Repository](../resources/Repository.md)
**Create a new file in repository**
**Operation ID:** `post--{repo_type}-{namespace}-{name}-raw-{file_path}`
...
**Schema:** [types.CreateFileReq](../schemas/types-CreateFileReq/types-CreateFileReq.md)
