...
| PUT | `/organization/{namespace}/members/{username}` | update user membership | [View](../operations/put-organization-namespace-members-username.md) |
| DELETE | `/organization/{namespace}/members/{username}` | Remove membership between org and user | [View](../operations/delete-organization-namespace-members-username.md) |
